from dependencies_loading import tf, keras, mpl, np, IMAGE_HEIGHT, IMAGE_WIDTH

def get_img_array(img_path, size=(IMAGE_HEIGHT, IMAGE_WIDTH, 3)):
...
print("Grad cam functions succesfully initialized")
